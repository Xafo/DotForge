...
export function MembersPage() {
  ...
  if (loading) return <p className="text-neutral-600">Loading members...</p>
                ...
                <tr key={m.userId} className="border-b border-neutral-100 dark:border-neutral-900">
                  ...
                  <td className="py-2 text-right">
                    {m.userId !== user?.userId && (
                      <button onClick={() => handleRemove(m.userId)} className="text-xs text-red-600 hover:text-red-500 cursor-pointer">Remove</button>
                    )}
                  </td>
                </tr>
              ))}
